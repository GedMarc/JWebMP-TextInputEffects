 ...
 */
@ComponentInformation(name = "Yoshiko Input Effect",
		description = "A very nice effect for inputs",
		url = "https://tympanus.net/Development/TextInputEffects/index2.html")
public class YoshikoSet2Input
		extends Set2InputEffect<YoshikoSet2Input>
{
	/**
	 ...
	 * @param content
	 */
	public YoshikoSet2Input(Input input, Label label, Span content)
	{

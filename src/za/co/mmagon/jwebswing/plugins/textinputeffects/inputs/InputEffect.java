 ...
 */
abstract class InputEffect<J extends InputEffect<J>> extends Span<GlobalChildren, NoAttributes, InputEffect<J>>
{
	/**
	 ...
	 * @param content
	 */
	public InputEffect(String topEffectClass, Input input, Label label, Span content)
	{
		this.input = input;
		this.label = label;

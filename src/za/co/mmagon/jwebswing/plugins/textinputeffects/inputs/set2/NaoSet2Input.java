 ...
 */
@ComponentInformation(name = "Nao Input Effect", description = "A very nice effect for inputs", url = "https://tympanus.net/Development/TextInputEffects/index2.html")
public class NaoSet2Input extends Set2InputEffect
{
	/**

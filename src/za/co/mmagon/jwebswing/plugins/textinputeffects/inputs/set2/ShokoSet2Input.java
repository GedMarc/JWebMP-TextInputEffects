 ...
 */
@ComponentInformation(name = "Shoko Input Effect", description = "A very nice effect for inputs", url = "https://tympanus.net/Development/TextInputEffects/index2.html")
public class ShokoSet2Input extends Set2InputEffect
{
	/**
